...
public class Content {
    ...
    private java.util.List<RecommendersEntity> recommenders;
    private java.util.List<String> css;

    public static Content objectFromData(String str) {

        return new com.google.gson.Gson().fromJson(str, Content.class);
    }
    ...
    public static class SectionEntity {
        ...
        public static SectionEntity objectFromData(String str) {

            return new com.google.gson.Gson().fromJson(str, SectionEntity.class);
        }
    ...
    public static class RecommendersEntity {
        ...
        public static RecommendersEntity objectFromData(String str) {

            return new com.google.gson.Gson().fromJson(str, RecommendersEntity.class);
        }
